        ...
        while (!messageQueue.isEmpty()) {
            ...
            if (broadcastBlock.getHeight() >= minHeight) {
                ...
                miners.stream()
                        ...
                        .filter(msg -> !deliveredMessages.contains(msg))
                        .forEach(msg -> messageQueue.putIfAbsent(msg, currentTime + broadcastRNG.sampleExponential(msg.recipient.getConnectivity() * sender.getConnectivity())));
            }
